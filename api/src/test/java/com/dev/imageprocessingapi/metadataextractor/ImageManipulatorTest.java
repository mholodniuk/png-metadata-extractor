...
import static com.dev.imageprocessingapi.TestConst.CRITICAL_CHUNKS;
...
class ImageManipulatorTest {
    ...
    void cannotRemoveCriticalChunk() {
        ...
        Assertions.assertThrows(InvalidChunkDeletionException.class,
                () -> manipulator.removeSelectedChunks(image, List.of("PLTE", "IEND")));
    }
    ...
    void removeSelectedChunk() {
        ...
        var chunks = manipulator.removeSelectedChunks(image, chunksToDelete);
